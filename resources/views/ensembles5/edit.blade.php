                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        <center><h4 class="card-title">Modification des personnels</h4></center>
                                    </div>
                                    <div class="card-body">
                                    <form method="post" action="{{route('ensembles5.update', $id->id)}}">
                                            @csrf
                                            @method('put')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                <a href="{{route('ensembles5.index')}}" class="btn btn-danger" > Annuler</a>
                                            </div>
                                        </div>
                                    </form>
                                    </div>
